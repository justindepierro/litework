...
import type { AthleteGroup, WorkoutAssignment, AthleteKPI } from "@/types";
...
export function useAthletesOperations(
  ...
  const handleAddAthleteToGroup = useCallback(
    async (groupId: string, athleteId: string) => {
      try {
