...
export default function CustomRestTime({
  exercise,
  onUpdate,
}: CustomRestTimeProps) {
    ...
    <div className="bg-white rounded-xl border border-gray-200 p-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600">
            Customize recovery between sets
          </p>
        </div>
      </div>
          ...
          {restTimePresets.map((preset) => {
            ...
            return (
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  <div
                    className={`w-6 h-6 rounded-lg flex items-center justify-center ${getTypeColor(preset.type)}`}
                  >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  value={customTime}
                  onChange={(e) =>
                    handleCustomTimeChange(parseInt(e.target.value))
                  }
      ...
      <Alert variant="warning" title="💡 Rest Time Guidelines" className="mt-6">
        <ul className="text-xs space-y-1">
          ...
          <li>
            • <strong>Hypertrophy (6-12 reps):</strong> 1-3 minutes
          </li>
          <li>
            • <strong>Endurance (13+ reps):</strong> 30-90 seconds
          </li>
          <li>
