...
export function getMobileOptimizedClasses(baseClasses: string, mobileClasses?: string, isMobile?: boolean): string {
...
export function TouchButton({ 
  ...
  const baseClasses = 'transition-all duration-200 font-medium rounded-xl touch-manipulation active:scale-95';
  ...
  return (
    <div className={containerClasses}>
      <div className={modalClasses}>
        {/* Header */}
        <div className={`flex justify-between items-center p-4 sm:p-6 border-b ${deviceInfo.isMobile ? 'shrink-0' : ''}`}>
