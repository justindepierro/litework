...
const mockProgressData = [
  { date: "2024-10-01", exercise: "Bench Press", weight: 185, reps: 8, sets: 3, volume: 4440, oneRepMax: 231, athleteId: "athlete1" },
  { date: "2024-10-05", exercise: "Bench Press", weight: 190, reps: 8, sets: 3, volume: 4560, oneRepMax: 237, athleteId: "athlete1" },
  { date: "2024-10-10", exercise: "Bench Press", weight: 195, reps: 8, sets: 3, volume: 4680, oneRepMax: 244, athleteId: "athlete1" },
  { date: "2024-10-15", exercise: "Squats", weight: 225, reps: 10, sets: 3, volume: 6750, oneRepMax: 300, athleteId: "athlete2" },
  { date: "2024-10-20", exercise: "Squats", weight: 235, reps: 10, sets: 3, volume: 7050, oneRepMax: 313, athleteId: "athlete2" },
  { date: "2024-10-25", exercise: "Deadlift", weight: 275, reps: 5, sets: 3, volume: 4125, oneRepMax: 309, athleteId: "athlete1" },
];
...
export default function ProgressAnalyticsDashboard() {
  ...
  const exportData = () => {
    const csv = [
      ...
      ...chartData.map(row => [
        row.date, row.exercise, row.weight, row.reps, row.sets, row.volume, row.oneRepMax
      ])
    ...
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600">Track strength gains, volume, and performance trends</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          <h3 className="text-lg font-bold text-gray-900 mb-4">Strength Progression</h3>
          <div className="h-64 bg-gray-50 rounded-lg flex items-center justify-center">
            <div className="text-center">
              <BarChart3 className="w-12 h-12 text-gray-400 mx-auto mb-2" />
              <p className="text-gray-500">Chart visualization would go here</p>
              <p className="text-sm text-gray-400">Shows 1RM progression over time</p>
            </div>
          </div>
        </div>
        ...
        {/* Volume Trends */}
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          <h3 className="text-lg font-bold text-gray-900 mb-4">Volume Trends</h3>
          <div className="h-64 bg-gray-50 rounded-lg flex items-center justify-center">
            <div className="text-center">
              <TrendingUp className="w-12 h-12 text-gray-400 mx-auto mb-2" />
              <p className="text-gray-500">Chart visualization would go here</p>
              <p className="text-sm text-gray-400">Shows total volume over time</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-200">
                ...
                <th className="text-left py-3 px-4 font-semibold text-gray-700">Improvement</th>
            ...
            <tbody>
              {analyticsSummary.topExercises.map((exercise, index) => (
                <tr key={index} className="border-b border-gray-100 hover:bg-gray-50">
                  ...
                  <td className="py-4 px-4 text-gray-600">{exercise.sessions}</td>
                  <td className="py-4 px-4">
                    <span className="text-green-600 font-medium">+{exercise.improvement}%</span>
                  </td>
                  <td className="py-4 px-4">
          ...
          {chartData.slice(-5).map((activity, index) => (
            <div key={index} className="flex items-center gap-4 p-3 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                <div className="font-medium text-gray-900">{activity.exercise}</div>
                <div className="text-sm text-gray-600">
                  {activity.weight}lbs × {activity.reps} × {activity.sets} = {activity.volume.toLocaleString()} total lbs
                </div>
              </div>
