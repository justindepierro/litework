      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              <label htmlFor="push_enabled" className="text-sm font-medium text-gray-900">
                Push Notifications
              </label>
          ...
          <div className="flex items-center justify-between">
            <div>
              <label htmlFor="email_enabled" className="text-sm font-medium text-gray-900">
                Email Notifications
              </label>
              <p className="text-sm text-gray-500">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              <label htmlFor="workout_reminders" className="text-sm font-medium text-gray-900">
                ⏰ Workout Reminders
              </label>
              <p className="text-sm text-gray-500">
          ...
          <div className="flex items-start">
            <div className="flex items-center h-5">
              <input
                ...
                onChange={(e) => updatePreference('assignment_notifications', e.target.checked)}
                className="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
              />
            </div>
            <div className="ml-3">
              <label htmlFor="assignment_notifications" className="text-sm font-medium text-gray-900">
                💪 New Assignments
              </label>
              <p className="text-sm text-gray-500">
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              <label htmlFor="message_notifications" className="text-sm font-medium text-gray-900">
                💬 Coach Messages
              </label>
              <p className="text-sm text-gray-500">
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              <label htmlFor="progress_updates" className="text-sm font-medium text-gray-900">
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              <label htmlFor="achievement_notifications" className="text-sm font-medium text-gray-900">
                🏆 Achievements & PRs
              </label>
              <p className="text-sm text-gray-500">
