 ...
 * Handles all client-side profile interactions including avatar upload,
 * form state management, and password changes
 */
...
export default function ProfileClient({ user }: ProfileClientProps) {
  ...
  const { showSkeleton } = useMinimumLoadingTime(isLoadingProfile, 300);
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
            ...
            <div className="relative flex-shrink-0">
              {avatarPreview || profile?.avatarUrl ? (
                ...
                <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-full bg-secondary flex items-center justify-center">
                  <UserIcon className="w-12 h-12 sm:w-16 sm:h-16 text-tertiary" />
                </div>
              )}
            </div>
        ...
        <div className="bg-white rounded-lg shadow-sm overflow-hidden">
          <div className="flex">
            ...
            >
              <UserIcon className="w-4 h-4 inline mr-1 sm:mr-2" />
