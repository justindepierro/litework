-- Phase 3: Goals & Motivation System
...
CREATE INDEX idx_athlete_goals_status ON athlete_goals(status);
CREATE INDEX idx_athlete_goals_deadline ON athlete_goals(deadline);
CREATE INDEX idx_athlete_goals_exercise_id ON athlete_goals(exercise_id) WHERE exercise_id IS NOT NULL;
...
-- Coaches can view their athletes' goals
...
CREATE INDEX idx_athlete_achievements_type ON athlete_achievements(achievement_type);
CREATE INDEX idx_athlete_achievements_earned_at ON athlete_achievements(earned_at DESC);

-- Prevent duplicate achievements
CREATE UNIQUE INDEX idx_athlete_achievements_unique 
...
-- Coaches can view athlete achievements
...
CREATE INDEX idx_strength_standards_exercise ON strength_standards(exercise_id);
CREATE INDEX idx_strength_standards_bodyweight ON strength_standards(bodyweight_category);
