...
// Interactive card
className="bg-white rounded-lg shadow-sm hover:shadow-md hover:border-orange-300 transition-all cursor-pointer"

// Gradient card
className="bg-gradient-to-br from-white to-orange-50/30 rounded-lg shadow-sm border border-orange-100"
```
