...
console.log(
  `📏 Migration size: ${migrationSQL.length} characters (${migrationSQL.split("\n").length} lines)\n`
);
...
console.log("─".repeat(70));
console.log(
  "1. Open: https://supabase.com/dashboard/project/lzsjaqkhdoqsafptqpnt"
);
...
console.log(
  "• Quick instructions: scripts/database/apply-migration-instructions.md\n"
);
