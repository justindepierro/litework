...
async function testWorkoutCreation() {
  ...
  if (retrieveError) {
    ...
    console.log('   Exercises:', completeWorkout.workout_exercises?.length || 0);
    console.log('   Groups:', completeWorkout.workout_exercise_groups?.length || 0);
...
async function checkSchema() {
  ...
  const tables = ['workout_plans', 'workout_exercises', 'workout_exercise_groups', 'workout_block_instances'];
